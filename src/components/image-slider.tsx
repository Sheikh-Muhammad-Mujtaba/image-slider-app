  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <Carousel
          className="rounded-lg overflow-hidden relative shadow-2xl border-2 border-slate-800 dark:border-slate-100"
        >
          <CarouselContent>
            {images.map((image, index) => (
              ...
              >
                ...
                />
                <div className="absolute bottom-[50%] left-1/2 -translate-x-1/2 flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={togglePlayPause}
                  className="bg-white/10 hover:bg-white/80 p-2 rounded-full shadow-md transition-colors"
                >
                  {isPlaying ? (
                ...
                <div className="p-2 bg-white/75 text-center  dark:bg-slate-700/75">
